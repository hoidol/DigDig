...
public class GameSetting
{
   ...
   public static Color playerDamageColor = new Color32(0xFF, 0xA7, 0x01, 0xFF); //FFA701
   public static Color playerCrtDamageColor = new Color32(0xFF, 0x00, 0x00, 0xFF);//FF0000

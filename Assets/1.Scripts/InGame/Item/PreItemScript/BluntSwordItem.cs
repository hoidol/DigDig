...
public class BluntSwordItem : TriggerItem
{
    ...
    public override void OnEquip()
    {
        base.OnEquip();
        coolTime = 5;
        transform.parent = Character.Instance.bodyRootTr;
    ...
    public override void OnTrigger()
    {
        ...
        float damage = Character.Instance.statMgr.AttackPower * MULTI_DAMAGE;
        bool facingLeft = Character.Instance.bodyRootTr.localScale.x < 0;

...
public class MiniMeMergeDragUI : MonoSingleton<MiniMeMergeDragUI>
{
    public Image image;
    ...
    {
        MiniMeData miniMeData = MiniMeManager.Instance.GetMiniMeData(miniMe.key);
        image.sprite = miniMeData.thum;

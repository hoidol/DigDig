...
public class BossPhase : MonoBehaviour
{
    ...
    public EnemySpecialAttackPattern[] attackPatterns;
    public Boss boss;
    CancellationTokenSource cts;
    EnemySpecialAttackPattern currentPattern;
    ...
    {
        attackPatterns = GetComponentsInChildren<EnemySpecialAttackPattern>();
        this.boss = boss;
    }

    public EnemySpecialAttackPattern GetEnemySpecialAttackPattern(string key)
    {
    ...
    List<EnemySpecialAttackPattern> canPatterns = new List<EnemySpecialAttackPattern>();
